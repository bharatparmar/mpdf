 ...
 * Licensed under MIT (https://github.com/benjaminkott/kastenhuber_theme/blob/master/LICENSE)
 * ========================================================================================== */
...
+function ($) {
    ...
    function Plugin() {
        return this.each(function() {
            var $this = $(this),
                data = $this.data('grcr.equalheight');
            if (!data) {
                $this.data('grcr.equalheight', (data = new EqualHeight(this)));
            } else {
                data.process();
            }
        });
    ...
    // ====================
    $(window).on('load resize calculate.grcr.equalheight', function() {
    ...
    $('img').on('load', function() {
        $(window).trigger('calculate.grcr.equalheight');
    });
