...
+function($) {
    ...
    ResponsiveImage.prototype.unveil = function(force) {
        ...
        if(inview){
            ...
            if (source) {
                ...
                $(window).trigger('loaded.grcr.responsiveimage');
                this.loaded	= true;
            }
        }
    };
    ...
    function Plugin(option) {
        ...
        return this.each(function() {
            var $this   = $(this);
            var data    = $this.data('grcr.responsiveimage');
            ...
            if (!data) {
                ...
                $this.data('grcr.responsiveimage', (data = new ResponsiveImage(this, options)));
            }
    ...
    // =====================
    $(window).on('load.grcr.responsiveimage', function() {
        ...
        // ======
        $(window)
            .on('scroll.grcr.responsiveimage', function(){
                $lazyload.responsiveimage('unveil');
            })
            .on('resize.grcr.responsiveimage', function(){
                if (viewport) viewport.update();
                $lazyload.responsiveimage('checkviewport');
            })
            .on('beforeprint.grcr.responsiveimage', function(){
                $lazyload.responsiveimage('print');
                $(window).trigger("readytoprint.grcr.responsiveimage");
            });
    });
